...
router.post("/admin/testimonials", authenticate, testimonialUpload, testimonialController.adminCreateTestimonial);
router.patch("/admin/testimonials/:id", authenticate, testimonialUpload, testimonialController.adminUpdateTestimonial);
